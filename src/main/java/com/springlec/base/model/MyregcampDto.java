...
public class MyregcampDto {
	...
	public MyregcampDto(int regSeq, String regTel, String regDetailaddress, String regName, Timestamp regDate,
	...
	public MyregcampDto(String regDetailaddress, String regSummary) {
		super();
		this.regDetailaddress = regDetailaddress;
		this.regSummary = regSummary;
	}
