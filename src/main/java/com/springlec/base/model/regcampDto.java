...
public class regcampDto {
	...
	public regcampDto(String regTel, String regCategory, String regDetailaddress, String regName, String regSummary,
			int host_hSeq) {
		super();
		this.regTel = regTel;
	...
	public regcampDto(int regSeq, String regTel, String regDetailaddress, String regName, String regDate,
			String regMdate, String regDdate, String regSummary, String regCategory, String regImage1, String regImage2,
			String regImage3, String regImage4, int host_hSeq) {
		super();
		this.regSeq = regSeq;
		this.regTel = regTel;
		this.regDetailaddress = regDetailaddress;
	...
	public String getRegMdate() {
		return regMdate;
	}

	public void setRegMdate(String regMdate) {
		this.regMdate = regMdate;
	}
